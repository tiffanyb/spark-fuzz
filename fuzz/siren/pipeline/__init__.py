...
See PIPELINE.md in this directory. Stage entry points:
...
The former fuzz/siren/pipeline.py (the per-candidate evaluation spec) is now
fuzz/siren/pipeline_spec.py -- a module and a package cannot share a name.
"""
